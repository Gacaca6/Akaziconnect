...
export default function EmployerMessageThread() {
  ...
  const initial = conversation.seekerName.charAt(0).toUpperCase();
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            {t('messageThread.applied_for')} {conversation.jobTitle}
          </p>
        </div>
      </div>
            ...
            return (
              <div
                ...
                className={`flex flex-col ${
                  isEmployer ? 'items-end' : 'items-start'
                }`}
              >
                <div
